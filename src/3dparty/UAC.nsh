...
!define _UAC_AUGOGR_ID_LINE ${__LINE__} ; fix for "could not resolve label"
!define _UAC_AUGOGR_ID _UAC_AUGOGR_OP${outvar}${op}${opparam1}${opparam2}_L${_UAC_AUGOGR_ID_LINE}
